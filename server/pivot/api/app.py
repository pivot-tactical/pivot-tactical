...
@asynccontextmanager
async def _app_lifespan(app: FastAPI, cfg: Settings, manager: SessionManager | None = None):
    import asyncio
...
def _create_app_lifespan(
    ...
    return functools.partial(_app_lifespan, cfg=cfg, manager=manager)  # type: ignore
...
def create_app(
    ...
    # To restrict CORS safely, allow localhost and common private IP ranges.
