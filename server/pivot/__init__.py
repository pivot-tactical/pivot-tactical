...
server runtime: FastAPI API + WebSocket signalling, the WebRTC audio router,
the DSP engine, faster-whisper transcription, the SQLite data layer, and the
PySide6 instructor GUI.
